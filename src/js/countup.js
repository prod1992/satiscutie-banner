...
const mrCountup = ($ => {
  ...
  if (typeof scrollMonitor === "undefined") {
    throw new Error(
      "mrCountup requires scrollMonitor.js (https://github.com/stutrek/scrollMonitor)"
    );
  }
  ...
  class Countup {
    constructor(element) {
      ...
      this.end =
        parseFloat($element.data(Options.END), 10) ||
        parseFloat($element.text(), 10);
      ...
      this.decimalPlaces =
        parseInt($element.data(Options.DECIMAL_PLACES), 10) || 0;
